...
// import { Page, Document, Image, Text, PDFViewer } from "@react-pdf/renderer";
...
const EmployeePage: React.FC = (): JSX.Element => {
  ...
  //               <div
  //                 style={{
  //                   backgroundColor: themeColors.primario,
  //                   height: "40px",
  //                   width: "40px",
  //                   borderRadius: "50%",
  //                   display: "flex",
  ...
  return (
    <>
      ...
      {/* <MyPDF />
      <div>
        <h1>Generar PDF desde una imagen con ReactPDF</h1>
        <PDFDownloadLink document={<MyPDF />} fileName='mi_pdf.pdf'>

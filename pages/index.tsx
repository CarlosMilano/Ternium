...
import { useState, ChangeEvent, Reducer, useReducer, useEffect, useRef, MutableRefObject } from "react";
...
export default function Home() {
    ...
    // The data from the table empleados.
    const [dataEmpleadosFull, setDataEmpleadosFull] = useState<TableEmpleado[] | null>(null);
    ...
    return (
        <>
            ...
            {/* Dialogs */}
            <DialogUpload open={isUploadDialogOpen} onClose={() => setIsUploadDialogOpen(false)}></DialogUpload>
        </>
    );
}
